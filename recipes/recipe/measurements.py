...
supported_goods = [
    ...
    dict(name="lemon", package="whole", volume_quantity=3, volume_unit="fluid_ounce", weight_quantity=2.5, weight_unit="ounce"),
    ...
    # Oils
    dict(name="extra-virgin olive oil", package="16 fluid ounce bottle", volume_quantity=16.0, volume_unit="fluid_ounce", weight_quantity=13, weight_unit='ounce'),
    # Dairy
